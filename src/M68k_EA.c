...
uint32_t INTERPRET_LoadFrom_EA_Mod0(void *, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t src_reg = ea & 7;
    uint32_t dn = state->D[src_reg].u32;
    ...
    switch (size) {
        case 4:
            *(uint32_t *)out = dn;
            break;
        case 2:
            *(uint16_t *)out = (uint16_t)dn;
            break;
        case 1:
            *(uint8_t *)out = (uint8_t)dn;
            break;
        default:
...
uint32_t INTERPRET_LoadFrom_EA_Mod1(void *, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t src_reg = ea & 7;
...
uint32_t INTERPRET_LoadFrom_EA_Mod2(void *, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t src_reg = ea & 7;
    uint32_t addr = state->A[src_reg].u32;
...
uint32_t INTERPRET_LoadFrom_EA_Mod3(void *, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t src_reg = ea & 7;
    uint32_t addr = state->A[src_reg].u32;
    ...
    switch (size) {
        case 4:
            *(uint32_t *)out = *(uint32_t *)(uintptr_t)addr;
            state->A[src_reg].u32 += 4;
            break;
        case 2:
            *(uint16_t *)out = *(uint16_t *)(uintptr_t)addr;
            state->A[src_reg].u32 += 2;
            break;
        case 1:
            *(uint8_t *)out = *(uint8_t *)(uintptr_t)addr;
            state->A[src_reg].u32 += (src_reg == 7) ? 2 : 1;
            break;
        default:
            kprintf("[INT] INTERPRET_LoadFromEffectiveAddress: Invalid size %d\n", size);
            break;
...
uint32_t INTERPRET_LoadFrom_EA_Mod4(void *, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t src_reg = ea & 7;
    ...
    switch (size) {
        case 4:
            state->A[src_reg].u32 -= 4;
            *(uint32_t *)out = *(uint32_t *)(uintptr_t)state->A[src_reg].u32;
            break;
        case 2:
            state->A[src_reg].u32 -= 2;
            *(uint16_t *)out = *(uint16_t *)(uintptr_t)state->A[src_reg].u32;
            break;
        case 1:
            state->A[src_reg].u32 -= (src_reg == 7) ? 2 : 1;
            *(uint8_t *)out = *(uint8_t *)(uintptr_t)state->A[src_reg].u32;
            break;
        default:
            kprintf("[INT] INTERPRET_LoadFromEffectiveAddress: Invalid size %d\n", size);
            break;
...
uint32_t (*INTERPRET_LoadFrom_EA[8])(void * pc, uint8_t size, uint8_t ea, struct M68KState *state, void *out) = {
    INTERPRET_LoadFrom_EA_Mod0,
    INTERPRET_LoadFrom_EA_Mod1,
    INTERPRET_LoadFrom_EA_Mod2,
    INTERPRET_LoadFrom_EA_Mod3,
    INTERPRET_LoadFrom_EA_Mod4,
    INTERPRET_LoadFrom_EA_Mod5,
    INTERPRET_LoadFrom_EA_Mod6,
    INTERPRET_LoadFrom_EA_Mod7
};

uint32_t INTERPRET_LoadFromEffectiveAddress(void * pc, uint8_t size, uint8_t ea, struct M68KState *state, void *out)
{
    uint8_t mode = (ea >> 3) & 7;

    return INTERPRET_LoadFrom_EA[mode](pc, size, ea, state, out);
}
