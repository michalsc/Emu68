...
void MOVEM(uint32_t opcode)
{
    ...
    if constexpr (sizeof(Type) == 4) {
        ...
        if (Write) {
            if (PreDecMode) {
                if (regMask & 0x0001) *--base = Reg == 7 ? A7 - 2 : A7;
                if (regMask & 0x0002) *--base = Reg == 6 ? A6 - 2 : A6;
                if (regMask & 0x0004) *--base = Reg == 5 ? A5 - 2 : A5;
                if (regMask & 0x0008) *--base = Reg == 4 ? A4 - 2 : A4;
                if (regMask & 0x0010) *--base = Reg == 3 ? A3 - 2 : A3;
                if (regMask & 0x0020) *--base = Reg == 2 ? A2 - 2 : A2;
                if (regMask & 0x0040) *--base = Reg == 1 ? A1 - 2 : A1;
                if (regMask & 0x0080) *--base = Reg == 0 ? A0 - 2 : A0;
                if (regMask & 0x0100) *--base = D7;
                if (regMask & 0x0200) *--base = D6;
                if (regMask & 0x0400) *--base = D5;
                if (regMask & 0x0800) *--base = D4;
