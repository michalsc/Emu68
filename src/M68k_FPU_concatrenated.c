...
/* EA Decoding */
    ...
    [0020 ... 0047] = { { EMIT_AnIndir }, NULL, 0, 0, 2, 0, 0 },
...
static EMIT_Function JumpTableAnIndir[64] = { //(An)
    ...
    [074]         = { { EMIT_FMOVEM }, NULL, 0, 0, 2, 0, 12 }, //static, predecrement
    [076]         = { { EMIT_FMOVEM }, NULL, 0, 0, 2, 0, 12 }, //dynamic. predecrement
}
...
static EMIT_Function JumpTableEA[64] = { //(d16,An);(An,Xn);(xxx).(W|L)
    ...
    [074]         = { { EMIT_FMOVEM }, NULL, 0, 0, 2, 1, 12 }, //static, predecrement
    [076]         = { { EMIT_FMOVEM }, NULL, 0, 0, 2, 1, 12 }, //dynamic. predecrement
}
