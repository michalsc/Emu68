...
static struct OpcodeDef InsnTable[4096] = {
    [0x03c] = { { EMIT_ORI_TO_CCR }, NULL, SR_S | SR_CCR, SR_CCR, 2 },
    [0x07c] = { { EMIT_ORI_TO_SR }, NULL, SR_ALL, SR_ALL, 2 },
    [0x23c] = { { EMIT_ANDI_TO_CCR }, NULL, SR_S | SR_CCR, SR_CCR, 2 },
    [0x27c] = { { EMIT_ANDI_TO_SR }, NULL, SR_ALL, SR_ALL, 2 },
    [0xa3c] = { { EMIT_EORI_TO_CCR }, NULL, SR_S | SR_CCR, SR_CCR, 2 },
    [0xa7c] = { { EMIT_EORI_TO_SR }, NULL, SR_ALL, SR_ALL },
    [0x000 ... 0x007] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 2 },
    [0x010 ... 0x039] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 2 },
    [0x040 ... 0x047] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 2 },
    [0x050 ... 0x079] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 2 },
    [0x080 ... 0x087] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 3 },
    [0x090 ... 0x0b9] = { { EMIT_ORI }, NULL, 0, SR_NZVC, 3 },
    [0x200 ... 0x207] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 2 },
    [0x210 ... 0x239] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 2 },
    [0x240 ... 0x247] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 2 },
    [0x250 ... 0x279] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 2 },
    [0x280 ... 0x287] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 3 },
    [0x290 ... 0x2b9] = { { EMIT_ANDI }, NULL, 0, SR_NZVC, 3 },
    [0x400 ... 0x407] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 2 },
    [0x410 ... 0x439] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 2 },
    [0x440 ... 0x447] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 2 },
    [0x450 ... 0x479] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 2 },
    [0x480 ... 0x487] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 3 },
    [0x490 ... 0x4b9] = { { EMIT_SUBI }, NULL, 0, SR_CCR, 3 },
    [0x600 ... 0x607] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 2 },
    [0x610 ... 0x639] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 2 },
    [0x640 ... 0x647] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 2 },
    [0x650 ... 0x679] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 2 },
    [0x680 ... 0x687] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 3 },
    [0x690 ... 0x6b9] = { { EMIT_ADDI }, NULL, 0, SR_CCR, 3 },
