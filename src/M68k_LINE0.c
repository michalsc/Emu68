...
static struct OpcodeDef InsnTable[4096] = {
	...
	[0xa00 ... 0xa07] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 2, 0, 1 },
	[0xa10 ... 0xa39] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 2, 1, 1 },
	[0xa40 ... 0xa47] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 2, 0, 2 },
	[0xa50 ... 0xa79] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 2, 1, 2 },
	[0xa80 ... 0xa87] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 3, 0, 4 },
	[0xa90 ... 0xab9] = { { EMIT_EORI }, NULL, 0, SR_NZVC, 3, 1, 4 },

	[0xc00 ... 0xc07] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 2, 0, 1 },
	[0xc10 ... 0xc3b] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 2, 1, 1 },
	[0xc40 ... 0xc47] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 2, 0, 2 },
	[0xc50 ... 0xc7b] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 2, 1, 2 },
	[0xc80 ... 0xc87] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 3, 0, 4 },
	[0xc90 ... 0xcbb] = { { EMIT_CMPI }, NULL, 0, SR_NZVC, 3, 1, 4 },

	[0x800 ... 0x807] = { { EMIT_BTST }, NULL, 0, SR_Z, 2, 0, 4 },
	[0x810 ... 0x83b] = { { EMIT_BTST }, NULL, 0, SR_Z, 2, 1, 1 },
	[0x100 ... 0x107] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x110 ... 0x13c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x300 ... 0x307] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x310 ... 0x33c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x500 ... 0x507] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x510 ... 0x53c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x700 ... 0x707] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x710 ... 0x73c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x900 ... 0x907] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x910 ... 0x93c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xb00 ... 0xb07] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xb10 ... 0xb3c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xd00 ... 0xd07] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xd10 ... 0xd3c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xf00 ... 0xf07] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xf10 ... 0xf3c] = { { EMIT_BTST }, NULL, 0, SR_Z, 1, 1, 1 },

	[0x840 ... 0x847] = { { EMIT_BCHG }, NULL, 0, SR_Z, 2, 0, 4 },
	[0x850 ... 0x879] = { { EMIT_BCHG }, NULL, 0, SR_Z, 2, 1, 1 },
	[0x140 ... 0x147] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x150 ... 0x179] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x340 ... 0x347] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x350 ... 0x379] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x540 ... 0x547] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x550 ... 0x579] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x740 ... 0x747] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x750 ... 0x779] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x940 ... 0x947] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x950 ... 0x979] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xb40 ... 0xb47] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xb50 ... 0xb79] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xd40 ... 0xd47] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xd50 ... 0xd79] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xf40 ... 0xf47] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xf50 ... 0xf79] = { { EMIT_BCHG }, NULL, 0, SR_Z, 1, 1, 1 },

	[0x880 ... 0x887] = { { EMIT_BCLR }, NULL, 0, SR_Z, 2, 0, 4 },
	[0x890 ... 0x8b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 2, 1, 1 },
	[0x180 ... 0x187] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x190 ... 0x1b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x380 ... 0x387] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x390 ... 0x3b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x580 ... 0x587] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x590 ... 0x5b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x780 ... 0x787] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x790 ... 0x7b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0x980 ... 0x987] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0x990 ... 0x9b9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xb80 ... 0xb87] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xb90 ... 0xbb9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xd80 ... 0xd87] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xd90 ... 0xdb9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },
	[0xf80 ... 0xf87] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 0, 4 },
	[0xf90 ... 0xfb9] = { { EMIT_BCLR }, NULL, 0, SR_Z, 1, 1, 1 },

	[04300 ... 04307] = { { EMIT_BSET }, NULL, 0, SR_Z, 2, 0, 4 },
	[04320 ... 04371] = { { EMIT_BSET }, NULL, 0, SR_Z, 2, 1, 1 },
	[00700 ... 00707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[00720 ... 00771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[01700 ... 01707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[01720 ... 01771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[02700 ... 02707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[02720 ... 02771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[03700 ... 03707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[03720 ... 03771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[04700 ... 04707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[04720 ... 04771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[05700 ... 05707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[05720 ... 05771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[06700 ... 06707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[06720 ... 06771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },
	[07700 ... 07707] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 0, 4 },
	[07720 ... 07771] = { { EMIT_BSET }, NULL, 0, SR_Z, 1, 1, 1 },

	[05320 ... 05371] = { { EMIT_CAS }, NULL, 0, SR_NZVC, 2, 1, 1 },
	[06320 ... 06371] = { { EMIT_CAS }, NULL, 0, SR_NZVC, 2, 1, 2 },
	[07320 ... 07371] = { { EMIT_CAS }, NULL, 0, SR_NZVC, 2, 1, 4 },
	...
	[02350 ... 02373] = { { EMIT_CMP2 }, NULL, 0, SR_NZVC, 2, 1, 4 },

	[0x108 ... 0x10f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x148 ... 0x14f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x188 ... 0x18f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x1c8 ... 0x1cf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x308 ... 0x30f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x348 ... 0x34f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x388 ... 0x38f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x3c8 ... 0x3cf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x508 ... 0x50f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x548 ... 0x54f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x588 ... 0x58f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x5c8 ... 0x5cf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x708 ... 0x70f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x748 ... 0x74f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x788 ... 0x78f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x7c8 ... 0x7cf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x908 ... 0x90f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x948 ... 0x94f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x988 ... 0x98f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0x9c8 ... 0x9cf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xb08 ... 0xb0f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xb48 ... 0xb4f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xb88 ... 0xb8f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xbc8 ... 0xbcf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xd08 ... 0xd0f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xd48 ... 0xd4f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xd88 ... 0xd8f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xdc8 ... 0xdcf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xf08 ... 0xf0f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xf48 ... 0xf4f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xf88 ... 0xf8f] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },
	[0xfc8 ... 0xfcf] = { { EMIT_MOVEP }, NULL, 0, 0, 2, 0, 0 },

	[07020 ... 07071] = { { EMIT_MOVES }, NULL, 0, 0, 2, 1, 1 },
	[07120 ... 07171] = { { EMIT_MOVES }, NULL, 0, 0, 2, 1, 2 },
	[07220 ... 07271] = { { EMIT_MOVES }, NULL, 0, 0, 2, 1, 4 },
};
