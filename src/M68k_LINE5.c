...
static struct OpcodeDef InsnTable[512] = {
	...
	[0300 ... 0307] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 0, 1 },
	[0710 ... 0717] = { { .od_Emit = EMIT_DBcc }, NULL, SR_CCR, 0, 2, 0, 0 },
	[0320 ... 0347] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 0, 1 },
	[0350 ... 0371] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 1, 1 },
	...
	[0700 ... 0707] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 0, 1  },
	[0310 ... 0317] = { { .od_Emit = EMIT_DBcc }, NULL, SR_CCR, 0, 2, 0, 0 },
	[0720 ... 0747] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 0, 1  },
	[0750 ... 0771] = { { .od_Emit = EMIT_Scc }, NULL, SR_CCR, 0, 1, 1, 1  },
