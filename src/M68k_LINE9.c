...
uint32_t EMIT_SUB_ext(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUB_reg")));
uint32_t EMIT_SUB_mem(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUB_reg")));
...
uint32_t EMIT_SUBA_ext(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUBA_reg")));
uint32_t EMIT_SUBA_mem(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUBA_reg")));
...
uint32_t EMIT_SUBX_ext(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUBX_reg")));
uint32_t EMIT_SUBX_mem(struct TranslatorContext *ctx, uint16_t opcode) __attribute__((alias("EMIT_SUBX_reg")));
