...
public:
    ...
    Register& operator=(Register& other) { _decrease_and_release(); _regnum = other._regnum; _role = other._role; _refcount = other._refcount; (*_refcount)++; return *this; }
    Register& operator=(const Register& other) { _decrease_and_release(); _regnum = other._regnum; _role = other._role; _refcount = other._refcount; (*_refcount)++; return *this; }
    ...
    void alloc() { _decrease_and_release(); _regnum = RegisterAllocator< Arch, RegType >().allocate(); _role = Role::TempReg; _refcount = allocator<uint32_t>().allocate(1); (*_refcount) = 1; }
