...
uint32_t udf(uint16_t immed)
{
    return INSN_TO_LE(0xe7f000f0 | (immed & 0x0f) | ((immed & 0xfff0) << 4));
}

uint32_t mov_reg(uint8_t reg, uint8_t src)
{
    return INSN_TO_LE(0xe1a00000 | src | (reg << 12));
}

uint32_t mov_immed_u8(uint8_t reg, uint8_t val)
{
    reg = reg & 0x0f;
    return INSN_TO_LE(0xe3a00000 | val | (reg << 12));
}

uint32_t movs_immed_u8(uint8_t reg, uint8_t val)
{
    reg = reg & 0x0f;
    return INSN_TO_LE(0xe3a00000 | val | (reg << 12) | (1 << 20));
}

uint32_t mov_immed_u8_shift(uint8_t reg, uint8_t val, uint8_t shift)
{
    reg = reg & 0x0f;
    shift &= 0x0f;
...
uint32_t movs_immed_u8_shift(uint8_t reg, uint8_t val, uint8_t shift)
{
    reg = reg & 0x0f;
    shift &= 0x0f;
...
uint32_t mvn_immed_u8(uint8_t reg, uint8_t val)
{
    reg = reg & 0x0f;
    return INSN_TO_LE(0xe3e00000 | val | (reg << 12));
}

uint32_t mvns_immed_u8(uint8_t reg, uint8_t val)
{
    reg = reg & 0x0f;
    return INSN_TO_LE(0xe3e00000 | val | (reg << 12) | (1 << 20));
}

uint32_t mvn_immed_u8_shift(uint8_t reg, uint8_t val, uint8_t shift)
{
    reg = reg & 0x0f;
    shift &= 0x0f;
...
uint32_t mvns_immed_u8_shift(uint8_t reg, uint8_t val, uint8_t shift)
{
    reg = reg & 0x0f;
    shift &= 0x0f;
...
uint32_t mov_immed_s8(uint8_t reg, int8_t val)
{
    reg = reg & 0x0f;
    if (val > 0)
...
uint32_t movs_immed_s8(uint8_t reg, int8_t val)
{
    reg = reg & 0x0f;
    if (val >= 0)
...
uint32_t bic_immed(uint8_t dest, uint8_t src, uint8_t mask)
{
    dest = dest & 15;
    src = src & 15;
...
uint32_t add_cc_immed(uint8_t cc, uint8_t dest, uint8_t src, uint8_t value)
{
    dest = dest & 15;
    src = src & 15;
...
uint32_t add_immed(uint8_t dest, uint8_t src, uint8_t value)
{
    return add_cc_immed(ARM_CC_AL, dest, src, value);
}

uint32_t add_cc_reg(uint8_t cc, uint8_t dest, uint8_t src, uint8_t reg, uint8_t lsl)
{
    dest = dest & 15;
    src = src & 15;
    reg = reg & 15;
...
uint32_t add_reg(uint8_t dest, uint8_t src, uint8_t reg, uint8_t lsl)
{
    return add_cc_reg(ARM_CC_AL, dest, src, reg, lsl);
}

uint32_t sub_cc_immed(uint8_t cc, uint8_t dest, uint8_t src, uint8_t value)
{
    dest = dest & 15;
    src = src & 15;
...
uint32_t sub_immed(uint8_t dest, uint8_t src, uint8_t value)
{
    return sub_cc_immed(ARM_CC_AL, dest, src, value);
}

uint32_t or_cc_immed(uint8_t cc, uint8_t dest, uint8_t src, uint8_t value)
{
    return INSN_TO_LE(0x03800000 | (cc << 28) | (dest << 12) | (src << 16) | value);
}

uint32_t or_immed(uint8_t dest, uint8_t src, uint8_t value)
{
    return or_cc_immed(ARM_CC_AL, dest, src, value);
}

uint32_t lsl_cc_immed(uint8_t cc, uint8_t dest, uint8_t src, uint8_t value)
{
    return INSN_TO_LE(0x01a00000 | (cc << 28) | (dest << 12) | src | ((value & 0x1f) << 7));
}

uint32_t lsl_immed(uint8_t dest, uint8_t src, uint8_t value)
{
    return lsl_cc_immed(ARM_CC_AL, dest, src, value);
}

uint32_t str_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t str_offset(uint8_t dest, uint8_t src, int16_t offset)
{
    return str_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t str_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t str_offset_preindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return str_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t str_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t str_offset_postindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return str_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldr_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldr_offset(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldr_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t ldr_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldr_offset_preindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldr_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldr_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldr_offset_postindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldr_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldr_cc_regoffset(uint8_t cc, uint8_t dest, uint8_t src, uint8_t reg, uint8_t shift)
{
    return INSN_TO_LE(0x07900000 | (cc << 28) | (dest << 16) | (src << 12) | reg | ((shift & 0x1f) << 7));
}

uint32_t ldr_regoffset(uint8_t dest, uint8_t src, uint8_t reg, uint8_t shift)
{
    return ldr_cc_regoffset(ARM_CC_AL, dest, src, reg, shift);
}

uint32_t ldrh_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t ldrh_offset(uint8_t dest, uint8_t src, int8_t offset)
{
    return ldrh_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrh_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t ldrh_offset_preindex(uint8_t dest, uint8_t src, int8_t offset)
{
    return ldrh_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrh_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t ldrh_offset_postindex(uint8_t dest, uint8_t src, int8_t offset)
{
    return ldrh_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrh_cc_regoffset(uint8_t cc, uint8_t dest, uint8_t src, uint8_t offset)
{
    return INSN_TO_LE(0x019000b0 | (cc << 28) | (dest << 16) | (src << 12) | (offset & 0x0f));
}

uint32_t ldrh_regoffset(uint8_t dest, uint8_t src, uint8_t offset)
{
    return ldrh_cc_regoffset(ARM_CC_AL, dest, src, offset);
}

uint32_t strh_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t strh_offset(uint8_t dest, uint8_t src, int8_t offset)
{
    return strh_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t strh_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t strh_offset_preindex(uint8_t dest, uint8_t src, int8_t offset)
{
    return strh_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t strh_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t strh_offset_postindex(uint8_t dest, uint8_t src, int8_t offset)
{
    return strh_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t strh_cc_regoffset(uint8_t cc, uint8_t dest, uint8_t src, uint8_t offset)
{
    return INSN_TO_LE(0x018000b0 | (cc << 28) | (dest << 16) | (src << 12) | (offset & 0x0f));
}

uint32_t strh_regoffset(uint8_t dest, uint8_t src, uint8_t offset)
{
    return strh_cc_regoffset(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrsh_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int8_t offset)
{
    if (offset >= 0)
...
uint32_t ldrsh_offset(uint8_t dest, uint8_t src, int8_t offset)
{
    return ldrsh_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrb_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldrb_offset(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldrb_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrb_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldrb_offset_preindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldrb_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrb_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t ldrb_offset_postindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return ldrb_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t ldrb_cc_regoffset(uint8_t cc, uint8_t dest, uint8_t src, uint8_t offset, uint8_t shift)
{
    return INSN_TO_LE(0x07d00000 | (cc << 28) | (dest << 16) | (src << 12) | offset | ((shift & 0x1f) << 7));
}

uint32_t ldrb_regoffset(uint8_t dest, uint8_t src, uint8_t offset, uint8_t shift)
{
    return ldrb_cc_regoffset(ARM_CC_AL, dest, src, offset, shift);
}

uint32_t strb_cc_offset(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t strb_offset(uint8_t dest, uint8_t src, int16_t offset)
{
    return strb_cc_offset(ARM_CC_AL, dest, src, offset);
}

uint32_t strb_cc_offset_preindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t strb_offset_preindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return strb_cc_offset_preindex(ARM_CC_AL, dest, src, offset);
}

uint32_t strb_cc_offset_postindex(uint8_t cc, uint8_t dest, uint8_t src, int16_t offset)
{
    if (offset >= 0)
...
uint32_t strb_offset_postindex(uint8_t dest, uint8_t src, int16_t offset)
{
    return strb_cc_offset_postindex(ARM_CC_AL, dest, src, offset);
}

uint32_t strb_cc_regoffset(uint8_t cc, uint8_t dest, uint8_t src, uint8_t offset, uint8_t shift)
{
    return INSN_TO_LE(0x07c00000 | (cc << 28) | (dest << 16) | (src << 12) | offset | ((shift & 0x1f) << 7));
}

uint32_t strb_regoffset(uint8_t dest, uint8_t src, uint8_t offset, uint8_t shift)
{
